...
router.post('/create-academic-department', validationRequest(academicDepartmentVlidation.academicDepartmentVlidationSchema), AcademicDepartmentController.createAcademicDepartment)
